...
from solution import get_events_time, calculate_overlap, appearance


class TestAppearance(unittest.TestCase):

    def test_get_events_time(self):
        intervals = [1, 3, 5, 7]
        expected = [(1, 'start'), (3, 'end'), (5, 'start'), (7, 'end')]
        self.assertEqual(get_events_time(intervals), expected)
    ...
    def test_calculate_overlap(self):
        ...
        expected = 3117
        self.assertEqual(calculate_overlap(lesson, pupil, tutor), expected)
